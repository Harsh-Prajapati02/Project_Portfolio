...
export const BentoGrid = ({
    ...
    return (
        <div
            className={cn(
                "grid md:auto-rows-[7rem] grid-cols-1 md:grid-cols-5 gap-6 max-w-7xl mx-auto",
                className
            )}
        >
            {children}
...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('prajapati.harsh0206@gmail.com')
        setCopied(true);  
    }
    ...
    return (
        ...
        >
            ...
            <div className={`${id === 6 && 'flex justify-center'} h-full`}>
                ...
                <div className={cn(
                    titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10 lg:py-6'
                )}>
                    ...
                    {id === 3 && (
                        ...
                        ">
                                <span className="py-4 px-3 rounded-lg text-center bg-[#10132e]" />
                                {['Next.js', 'TypeScript', 'JavaScript'].map((item) => (
                                    <span key={item} className="py-2 lg:py-2 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132e]">
                                        {item}
                                    </span>
                                ))}
